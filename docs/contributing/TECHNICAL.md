...
| [`opencode/`](../hooks/opencode/README.md) | OpenCode | TypeScript plugin, in-place mutation (OpenCode 2.0 & 1.x) |
...
| OpenCode | TS plugin | execute.before / tool.execute.before | Yes (in-place mutation) |
